...
export const getLevel2 = (game: Game) => createLevel(game, 60000, (scene) => {
    assignFurniture(scene, game, 2);
    ...
    scene.projectiles = [
        ...
        new Projectile(new Vec(56, 226), new Vec(0, 0), game, 0),
    ];

    scene.rats = [
        new Rat([340, 340], game, 2.5),
        new Rat([340, 340], game, 2.9),
        new Rat([340, 340], game, 3.6),
        new Rat([340, 340], game, 3.1),

        new Rat([80, 280], game, 2.6),
        new Rat([80, 280], game, 2.4),
        new Rat([80, 280], game, 2.8),
        new Rat([80, 280], game, 3.5),

        new Rat([700, 400], game, 3.5),
        new Rat([700, 400], game, 3),
        new Rat([700, 400], game, 2.5),
        new Rat([700, 400], game, 2.8),
    ];
